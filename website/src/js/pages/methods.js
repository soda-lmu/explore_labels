...
const about = {
  ...
  "instruments.parquet": "One row per setup (84 LLM model × task designs, human versions A–E, pooled humans) and label (OL, HS): prevalence with intervals, reliability, and confidence summaries.",
  ...
  "run_prevalence.parquet": "Share of positive labels in each LLM run (model × task design × run), for each label.",
  ...
  "llm_annotations.parquet": "Every LLM label: tweet, label type, model, task design, run, label, and confidence (where requested).",
